...
@javax.persistence.Table(name = "hbn_archived_employee")
public class EmployeeArchive {
	 ...
	 */
	public EmployeeArchive(int employeeId, String employeeName, int employeeSalary) {
		super();
	...
	public EmployeeArchive(int employeeId, String employeeName, String employeeAddress, int employeeSalary) {
		super();
		this.employeeId = employeeId;
		this.employeeName = employeeName;
